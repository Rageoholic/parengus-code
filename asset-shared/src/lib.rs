...
impl SectionKind {
    ...
    pub fn to_u32(self) -> u32 {
        match self {
            ...
            Self::MeshTexRef => 7,
            Self::MeshSubMeshTable => 8,
            Self::MeshMaterialData => 9,
            Self::MeshSubMeshAlbedo => 10,
            Self::TextureMip => 100,
    ...
    pub fn from_u32(v: u32) -> Option<Self> {
        match v {
            ...
            8 => Some(Self::MeshSubMeshTable),
            9 => Some(Self::MeshMaterialData),
            10 => Some(Self::MeshSubMeshAlbedo),
